...
namespace Survivors.Scripts.Enemies.Enemy
{
    public sealed class EnemyFactory
    {
        ...
        public EnemyFactory(IPlayerHealthData playerHealthData, IPlayerTransformData playerTransformData,
        ...
        {
            var view = Object.Instantiate(settings.Prefab, position, Quaternion.identity).GetComponent<EnemyView>();
            var model = new EnemyModel(m_PlayerTransformData, m_PlayerHealthData, settings);
